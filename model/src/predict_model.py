...
if __name__ == '__main__':
    ...
    [test_loader, temp], (temp_channels, temp_w, temp_h), datasets_uids, datasets_uris = \
        get_dataloaders(
            args.data_info,
